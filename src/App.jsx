...
[작성 규칙]
1. 글자수: 45자 이내, 최대한 45자에 가깝게 작성
2. 키워드 배치: 상품수 적은 키워드(소형→중소형→중형→대형) 순으로 앞에 배치
3. 단어 구성: 서로 연관성 있는 단어끼리 인접하게 배치 (네이버 소싱 알고리즘 최적화)

위 규칙에 따라 상품명 3개를 작성해줘. 각 상품명 옆에 글자수도 표시해줘.`;
